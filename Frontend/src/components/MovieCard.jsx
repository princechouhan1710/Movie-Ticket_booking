...
function MovieCard({movie}) {
  ...
  return (
    <div className={`w-75 h-[450px] border  border-gray-300   m-auto md:m-0 rounded-b-lg lg:w-100  xl:w-75 overflow-hidden ${!movie.released && 'border-b-0'}`} onClick={() => { navigate(`/movies/${movie.encodeName}`); }}>
