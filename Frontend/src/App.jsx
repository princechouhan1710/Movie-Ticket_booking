...
function App() {
  ...
  return (<div>  <moviecontext.Provider value={{ Mov, setMovie }}>
    <theatrescontext.Provider value={{ theatres, setTheatres }}>
      {!["/loginadmin", "/dashboard","/dashboard/addmovie","/dashboard/addtheatre","/dashboard/allmovies","/dashboard/createshow","/dashboard/alltheatres","/booking/"].includes(location.pathname) && <Navbar />}

      <Routes>
         <Route element={<Layout />}>
          <Route path='/' element={<Home />}> </Route>
        <Route path='/UpComing' element={<Upcoming />}></Route>
        <Route path='/movies/:name' element={<MovieDetailPage />}></Route>
