...
function FrequentlyAskedQuestion() {
  return (
    <div className=' flex flex-col p-2 sm:p-4 lg:w-[750px] lg:m-auto gap-5 xl:w-[1000px] xl:m-auto'>
    ...
    <div className='font-medium '>How will I receive my ticket after booking?</div>
      ...
      <div className='flex items-center gap-3 text-slate-700'> <div className="w-1.5 h-1.5 bg-black rounded-full" />Available in My Orders</div>
      <div className='flex items-center gap-3 text-slate-700'> <div className="w-1.5 h-1.5 bg-black rounded-full" />Sent to your registered email / WhatsApp (if enabled)</div>
    ...
    <div className='font-medium '>What payment methods are supported?</div>
      <div className='text-slate-700 text-base'>We support:</div>
       <div className='flex items-center gap-3 text-slate-700'> <div className="w-1.5 h-1.5 bg-black rounded-full" />UPI</div>
      <div className='flex items-center gap-3 text-slate-700'> <div className="w-1.5 h-1.5 bg-black rounded-full" />Debit/Credit Cards</div>
       <div className='flex items-center gap-3 text-slate-700'> <div className="w-1.5 h-1.5 bg-black rounded-full" />Net Banking</div>
      <div className='flex items-center gap-3 text-slate-700'> <div className="w-1.5 h-1.5 bg-black rounded-full" />Wallets</div>
